        ...
        <div class="row">
                ...
                <div class="footer-box">
                    ...
                    <div class="footer-links">
                        <ul>
                            ...
                            <li><a href="<?= SITE_PATH; ?>about.php">About Us</a></li>
                            <li><a href="<?= SITE_PATH; ?>services.php">Services</a></li>
                            <li><a href="<?= SITE_PATH; ?>contact.php">Contact Us</a></li>
                            <li><a href="<?= SITE_PATH; ?>blog.php">Blog</a></li>
                            <li><a href="<?= SITE_PATH; ?>blog.php">Mission</a></li>
            ...
            <div class="col-lg-2">
                <div class="footer-box">
                    ...
                    <div class="footer-links">
                        <ul>
                            <li><a href="<?= SITE_PATH; ?>index.php">Gallery</a></li>
                            <li><a href="<?= SITE_PATH; ?>about.php">Privacy Policy</a></li>
                            <li><a href="<?= SITE_PATH; ?>services.php">Terms</a></li>
                            <li><a href="<?= SITE_PATH; ?>contact.php">Gallery</a></li>
